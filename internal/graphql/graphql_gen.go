...
var sources = []*ast.Source{
	{Name: "internal/graphql/schema/schema.graphql", Input: `"""The Query type represents all of the entry points into the API."""
type Query {
    """Returns all users"""
    users: [User!]!
}`, BuiltIn: false},
	{Name: "internal/graphql/schema/user.graphql", Input: `"""A single user entity"""
type User {
    id: ID!
    name: String!
}
